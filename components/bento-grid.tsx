    ...
    <section id="features" className="py-24 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
            ...
            <div className="flex items-start justify-between mb-8">
              <div>
                <div className="p-2 rounded-lg bg-zinc-800 w-fit mb-4">
                  <Link2 className="w-5 h-5 text-zinc-400" strokeWidth={1.5} />
                </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {["Research", "PRD", "Design Tokens", "Components", "Code"].map((stage, i) => (
                <div key={stage} className="flex items-center">
                  <span className="px-3 py-1.5 rounded-full bg-zinc-800 text-zinc-300 text-sm">{stage}</span>
          ...
          >
            <div className="p-2 rounded-lg bg-zinc-800 w-fit mb-4">
              <Lightbulb className="w-5 h-5 text-zinc-400" strokeWidth={1.5} />
            </div>
            <h3 className="text-lg font-semibold text-white mb-2">Ideate</h3>
            <p className="text-zinc-400 text-sm mb-4">Transform rough ideas into structured product concepts with AI-guided brainstorming.</p>
            <span className="text-xs text-zinc-500">Stage 1</span>
          </motion.div>
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-4">Validate with market research, competitor analysis, and user insights—all automated.</p>
            <span className="text-xs text-zinc-500">Stage 2</span>
          </motion.div>
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-4">Generate comprehensive PRDs with user stories, specs, and acceptance criteria.</p>
            <span className="text-xs text-zinc-500">Stage 3</span>
          </motion.div>
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-4">Create UI screens, design systems, and interactive prototypes from your PRD.</p>
            <span className="text-xs text-zinc-500">Stage 4</span>
          </motion.div>
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-4">Ship production-ready React/Next.js code with your designs baked in.</p>
            <span className="text-xs text-zinc-500">Stage 5</span>
          </motion.div>
        </motion.div>
      </div>
    </section>

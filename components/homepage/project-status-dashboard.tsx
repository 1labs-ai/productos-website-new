...
// Project stats - minimal monochrome
const projectStats = [
    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.06] bg-white/[0.02]">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-white/60 px-2 py-0.5 rounded-full bg-white/[0.06] border border-white/[0.08]">
            Ready to ship
          </span>
        </div>
                    ...
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {item.status === "complete" && (
                        <div className="w-4 h-4 rounded-full bg-white/[0.08] flex items-center justify-center">
                          <Check className="size-2.5 text-white/70" />
                        </div>
                      )}
          ...
          <div className="mt-6 p-4 rounded-xl bg-white/[0.03] border border-white/[0.08]">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-white/[0.06] flex items-center justify-center">
                <GitBranch className="size-5 text-white/60" />
              </div>
              <div>
